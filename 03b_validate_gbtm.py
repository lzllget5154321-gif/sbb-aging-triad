# =============================================================================
# 03b_validate_gbtm.py — GBTM 验证套件 (E1/E2/E3)
# =============================================================================
# 功能: E1: 2波模拟--比较2波vs4波拟合
#       E2: 年龄窗口分层--检查截距/斜率跨年龄稳定性
#       E3: 采样扰动--3波个体的组稳定性 (波次重采样)
# 输入: results/tables/charls_full_longitudinal.csv
# 输出: results/figures/gbtm_validate_*.png + results/tables/gbtm_validate_*.csv
# 依赖: pandas, numpy, sklearn (LinearRegression), matplotlib
# 用法: python 03b_validate_gbtm.py
