# =============================================================================
# causal_forest_extended.R — Causal Forest 扩展分析
# =============================================================================
# 功能: 跨库验证 (CHARLS/HRS/KLoSA/MHAS分别运行causal_forest)
#       + 倾向修剪 (propensity trimming) + 交互项检验 + 合并库分析
# 输入: results/tables/ 下各库 *_for_cf.csv (含 W/Y/X 列)
# 输出: results/tables/causal_forest_*.csv + results/figures/cf_*.png
# 依赖: R packages: grf, data.table, dplyr
# 用法: Rscript causal_forest_extended.R
